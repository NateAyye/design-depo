    ...
    <Dialog>
      <DialogTrigger asChild>
        {triggerElement ? triggerElement() : (
          <Button className='w-full justify-start px-2' variant='ghost'>Export</Button>
        )}
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        ...
        <Textarea rows={10} cols={20} className='resize-none' onChange={(e) => setCssFile(e.target.value)} value={cssFile}></Textarea>
        <DialogFooter>
          <Button onClick={() => {
