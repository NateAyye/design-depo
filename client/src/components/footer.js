...
function Footer() {
  return (
    <footer className="footer border-t pt-3">
      <div className="container">
        <div className="grid gap-5 grid-cols-2 sm:grid-cols-4 place-items-center">
          <div className="text-center">
            <p className="text-foreground font-bold text-2xl font-segoe">Design Depo</p>
            <small>Your one stop shop for all you color and design needs. No pay Walls Free EVERYTHING!!</small>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="flex flex-col justify-center">
              <li className="text-foreground">
                <Button asChild variant='link' className='px-0'>
                  <Link to={'https://github.com/NateAyye/design-depo/issues/new'}>Report Bug</Link>
                </Button>
              </li>
              <li className="text-foreground">
                <Button asChild variant='link' className='px-0'>
        ...
        <div className="flex justify-between">
          <span className="text-foreground">&copy; {new Date().getFullYear()}</span>
